    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      <div className="container mx-auto p-4 flex flex-col gap-4">
        <div className="flex justify-between items-center no-print flex-wrap gap-2">
          <h1 className="text-2xl font-bold text-gray-800">なっちゃって香盤表ジェネレーター</h1>
          <div className="flex gap-2">
            <label className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow transition cursor-pointer">
              読込
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="no-print bg-white p-6 rounded-lg shadow-md overflow-y-auto max-h-[calc(100vh-100px)]">
